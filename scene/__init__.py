...
class Scene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True,
        ...
        elif os.path.exists(os.path.join(args.source_path, "pi3.npz")):
            print("Found pi3.npz, assuming Pi3 data set!")
            scene_info = sceneLoadTypeCallbacks["pi3"](args.source_path)
        else:
